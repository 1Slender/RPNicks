...
namespace RPNicks
{
    public class Config : IConfig
    {
        ...
        public List<string> surnames { get; set; } = new List<string>() { "Сучков", "Арсеньев", "Тэйлор", "Авдеев", "Аксёнов", "Егоров", "Семченко", "Горохов", "Борщ", "Бабин", "Голобородько", "Хватаймуха", "Ткаченко", "Дмитриев", "Бирюков", "Жуков", "Пущин", "Некурящев", "Адидас", "Мухин", "Блинской", "Шпакян", "Васюков", "Федотов", "Рыжов", "Чарский", "Маслов", "Лобанов", "Цой", "Хой", "Литвинов", "Джованна", "Погребной", "Голосов", };
    }
}
